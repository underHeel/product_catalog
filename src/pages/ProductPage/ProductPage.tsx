  ...
  return (
    <div>
      <div className={styles.cardWrapper}>
        ...
        <div className={styles.picturesPreferences}>
        ...
        <div className={styles.aboutAndScpecsWrapper}>
          <div className={styles.aboutBlock}>
            <div className={styles.aboutText}>
              <h2>About</h2>
            </div>
            <div className={styles.paragraph}>
              <h3 className={styles.paragraphTitle}>And then there was Pro</h3>
              <div className={styles.paragraphText}>
                <br />
                A transformative triple‑camera system that adds tons of
                capability without complexity. <br /> <br />
            ...
            <div className={styles.paragraph}>
              <h3 className={styles.paragraphTitle}>Camera</h3>
              <div className={styles.paragraphText}>
                <br />
